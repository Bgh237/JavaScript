...
function listAllCatch() {
  ...
  for (var i = 0; i < speciesArray.length; i++) {
    outputText += "Species: " + speciesArray[i] + ", Length: " + lengths[i] + ", Weight: " + weights[i] + "<br>";
  }
...
function showAverageWeight() {
  ...
  outputText = "The average weight of all the fish caugh is " + averageWeight.toFixed(2) + "kg."
...
function findFish() {
  var outputText = "";
  var name = document.getElementById("txtSpeciesSearched").value;
  for (var i = 0; i < speciesArray.length; i++){
      if (speciesArray[i] === name) {
        outputText += "Species: " + speciesArray[i] + ", Length: " + lengths[i] + ", Weight: " + weights[i] + "<br>";
      }
  }
