...
var outputText1 = "Opening times today: " + library.openinghours.opens + " - " + library.openinghours.closes;

document.getElementById("pOutput").innerHTML = outputText + "<br>" + outputText1;
