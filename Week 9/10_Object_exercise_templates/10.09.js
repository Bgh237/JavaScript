...
function showWeatherInfo(jsonText) {
    ...
    var outputText = myObj.weather[0].description + 
                    "<br> Temperature (°): " + myObj.main.temp.toFixed(0) + 
                    "<br> Wind (m/s): " + myObj.wind.speed.toFixed(0) + 
                    "<br> Cloud (%): " + myObj.clouds.all.toFixed(0);
